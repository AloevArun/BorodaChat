...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MessageLineEdit.setGeometry(QtCore.QRect(170, 330, 261, 31))
        self.MessageLineEdit.setObjectName("MessageLineEdit")
        self.UserList = QtWidgets.QListView(self.centralwidget)
        self.UserList.setGeometry(QtCore.QRect(5, 29, 151, 331))
        self.UserList.setObjectName("UserList")
        self.SendButton = QtWidgets.QPushButton(self.centralwidget)
        self.SendButton.setGeometry(QtCore.QRect(440, 330, 81, 31))
        self.SendButton.setObjectName("SendButton")
        self.MessageList = QtWidgets.QListView(self.centralwidget)
        self.MessageList.setGeometry(QtCore.QRect(170, 30, 351, 291))
